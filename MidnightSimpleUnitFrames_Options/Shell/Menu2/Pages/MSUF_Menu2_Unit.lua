...
local STATUS_CONTROLS = {
    ...
    StatusControl("social", "Guild / Friend", "showSocialIndicator", false, "socialIndicatorSize", 16, "socialIndicatorAnchor", "TOPRIGHT", STATUS_CORNER_ANCHORS, "socialIndicatorOffsetX", -18, "socialIndicatorOffsetY", 2, "socialIndicatorLayer", 7, "MSUF_RequestStatusIconsRefreshForCurrent", { allowed = function(unit) return unit == "target" end, statusRuntime = true }),
...
local COPY_INDICATOR_FIELDS = M.CopyFieldsFromSpecs(STATUS_CONTROLS, "leader assist raidmarker raidgroupname eliteicon social", nil, "show iconStyle customIcon x y anchor size layer symbol")
local COPY_STATUSICON_FIELDS = M.CopyFieldsFromSpecs(STATUS_CONTROLS, "level raceText classText statusText statusGhostText statusAFKText statusAFKTimer statusDNDText statusCombat statusResting statusIncomingRes statusPvp", "statusIconsTestMode statusIconsMidnightStyle statusIconsAlpha statusTextEnabled", "show iconStyle customIcon x y anchor size layer symbol")
