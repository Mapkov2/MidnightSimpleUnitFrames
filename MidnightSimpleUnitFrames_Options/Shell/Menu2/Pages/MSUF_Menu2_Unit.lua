...
local STATUS_CONTROLS = {
    ...
    StatusControl("targetingYou", "Targeting You", "showTargetingYouIndicator", false, "targetingYouIndicatorSize", 18, "targetingYouIndicatorAnchor", "TOPRIGHT", STATUS_CORNER_ANCHORS, "targetingYouIndicatorOffsetX", -36, "targetingYouIndicatorOffsetY", 2, "targetingYouIndicatorLayer", 7, "MSUF_RequestStatusIconsRefreshForCurrent", { allowed = function(unit) return unit == "target" or unit == "focus" or unit == "boss" end, statusRuntime = true, customIcon = "targetingYouIndicatorCustomIcon" }),
...
local COPY_INDICATOR_FIELDS = M.CopyFieldsFromSpecs(STATUS_CONTROLS, "leader assist raidmarker raidgroupname eliteicon targetingYou", nil, "show iconStyle customIcon x y anchor size layer symbol")
