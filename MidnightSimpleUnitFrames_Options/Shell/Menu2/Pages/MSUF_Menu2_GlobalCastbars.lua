...
local function BuildCastbars(ctx)
    ...
    LazyCastbarSection({ sectionId = "castbar_interrupt_ready", title = "Interrupt Ready Indicator", height = 328, build = function(_, secBuilder) return BuildInterruptReadySection(S, secBuilder) end })
