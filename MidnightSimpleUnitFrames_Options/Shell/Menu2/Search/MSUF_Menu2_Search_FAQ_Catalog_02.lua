...
if type(Data.RegisterFAQProvider) == "function" then
    Data.RegisterFAQProvider(function(env)
        ...
        return Data.FAQRows({
            { l = "How do I make unit frames transparent?", a = "Open the unit page > Transparency for in-combat/out-of-combat alpha. Fade target chooses whether the sliders affect the whole frame, bars, HP, or backdrop. Group frame transparency is in Frames > Party/Raid Frames > Layout > Transparency.", p = "uf_player", t = "Opens: Player > Transparency", x = "Transparency alpha in combat out of combat opacity fade target whole frame layer fade bars hp bar backdrop background fill text portrait visible", k = "transparent unitframe|transparent unit frame|alpha unitframe|opacity unitframe|fade frame|frame alpha|whole frame alpha|fade target|in combat alpha|out of combat alpha|transparent player frame|transparent target frame|hp bar alpha|health bar alpha|bars alpha|backdrop alpha|text portrait visible", y = 40 },
        },
        {
            {
                l = "How do I make group frames transparent?",
                a = "Open Frames > Party/Raid Frames > Layout > Transparency. Opacity controls in-combat and out-of-combat alpha;" ..
                ...
                p = "gf_layout",
                t = "Opens: Frames > Party/Raid Frames > Layout > Transparency",
                x = "Group Frames Layout Transparency opacity fade target in combat out of combat alpha whole frame" ..
                    " bars HP backdrop HP fill HP track background fill",
                k = SearchKeywordList(
            ...
            },
            {
                ...
                a = "Open Frames > Party/Raid Frames > Layout for Smooth health fill. For group-frame power bars, open" ..
                    " Frames > Party/Raid Frames > Layout > Resource Bar > Smooth fill.",
                p = "gf_layout",
                t = "Opens: Frames > Party/Raid Frames > Layout > Smooth health fill",
