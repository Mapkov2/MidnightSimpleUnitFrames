...
Data.KEYWORDS = {
    ...
    uf_arena = "unit frame unitframe arena frames arenaframe arenaframes frame basics enable disable hide show width height scale size health power portrait text castbar arena range fade range check distance check out of range transparency alpha auras buffs debuffs preview anchoring anchor arena layout copy to edit mode move drag position x offset y offset color name hp power " .. UF_STATUS .. " arena opponent enemy pvp",
