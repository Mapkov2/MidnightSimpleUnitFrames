...
local PAGE_HELP = {
    ...
    auras3_custom = { title = "Custom Auras help", lines = { "Every supported UnitFrame has Custom 1, Custom 2, Custom 3, and Dots on target under its Auras section. The first three provide setup, whitelist, filters, and layout; Dots on target offers a curated Retail 12.0+/12.1 DoT list and always watches your current target for player-owned harmful auras.", "Icon styling and Secret-safe Full-Frame effects are scope-aware under Appearance > Auras for Buffs, Debuffs, Custom 1-3, and Dots on target." }, actions = { "Open Aura Style", "Open Target", "Open Player" } },
