...
local function SubjectAndMode(norm)
    local patterns = {
        ...
        -- The words players actually use for a control they cannot touch.
        { "^why%s+is%s+(.+)%s+greyed%s+out$", "diagnose" },
        { "^why%s+is%s+(.+)%s+grayed%s+out$", "diagnose" },
        { "^why%s+is%s+(.+)%s+greyed$", "diagnose" },
        { "^why%s+is%s+(.+)%s+grayed$", "diagnose" },
        { "^why%s+is%s+(.+)%s+locked$", "diagnose" },
        { "^why%s+is%s+(.+)%s+inactive$", "diagnose" },
        { "^why%s+is%s+(.+)%s+not%s+editable$", "diagnose" },
        { "^why%s+is%s+(.+)%s+not%s+available$", "diagnose" },
        { "^why%s+is%s+(.+)%s+not%s+clickable$", "diagnose" },
        { "^why%s+is%s+(.+)%s+read%s+only$", "diagnose" },
        { "^why%s+cant%s+(.+)%s+be%s+changed$", "diagnose" },
        { "^why%s+can't%s+(.+)%s+be%s+changed$", "diagnose" },
        { "^why%s+cannot%s+(.+)%s+be%s+changed$", "diagnose" },
        { "^why%s+cant%s+i%s+change%s+(.+)$", "diagnose" },
        { "^why%s+can't%s+i%s+change%s+(.+)$", "diagnose" },
        { "^why%s+cannot%s+i%s+change%s+(.+)$", "diagnose" },
        { "^why%s+can%s+i%s+not%s+change%s+(.+)$", "diagnose" },
        { "^why%s+cant%s+i%s+edit%s+(.+)$", "diagnose" },
        { "^why%s+can't%s+i%s+edit%s+(.+)$", "diagnose" },
        { "^why%s+cant%s+i%s+click%s+(.+)$", "diagnose" },
        { "^why%s+can't%s+i%s+click%s+(.+)$", "diagnose" },
        { "^why%s+cant%s+i%s+use%s+(.+)$", "diagnose" },
        { "^why%s+can't%s+i%s+use%s+(.+)$", "diagnose" },
        { "^what%s+does%s+(.+)%s+require$", "diagnose" },
        { "^what%s+does%s+(.+)%s+need$", "diagnose" },
        { "^what%s+does%s+(.+)%s+conflict%s+with$", "explain" },
        { "^what%s+conflicts%s+with%s+(.+)$", "explain" },
        { "^what%s+is%s+blocking%s+(.+)$", "diagnose" },
        { "^what%s+blocks%s+(.+)$", "diagnose" },
        { "^what%s+unlocks%s+(.+)$", "diagnose" },
        { "^how%s+do%s+i%s+unlock%s+(.+)$", "diagnose" },
