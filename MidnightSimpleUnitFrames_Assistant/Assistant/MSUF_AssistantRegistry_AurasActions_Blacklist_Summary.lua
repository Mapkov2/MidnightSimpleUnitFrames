...
function A.AurasRegistry.RegisterBlacklistSummaryAction(ctx)
    ...
    Registry:RegisterAction({
        ...
        aliases = {
            ...
            "show player aura blacklist", "show target aura blacklist", "show focus aura blacklist", "show boss aura blacklist", "show arena aura blacklist",
            "zeige player aura blacklist", "zeige target aura blacklist", "zeige focus aura blacklist", "zeige boss aura blacklist", "zeige arena aura blacklist",
            "player aura blacklist anzeigen", "target aura blacklist anzeigen", "focus aura blacklist anzeigen", "boss aura blacklist anzeigen", "arena aura blacklist anzeigen",
            "show current player aura blacklist", "show current target aura blacklist",
            "show current focus aura blacklist", "show current boss aura blacklist", "show current arena aura blacklist",
            "list player aura blacklist", "list target aura blacklist", "list focus aura blacklist", "list boss aura blacklist", "list arena aura blacklist",
            "current player aura blacklist", "current target aura blacklist",
            "current focus aura blacklist", "current boss aura blacklist", "current arena aura blacklist",
            "what is player aura blacklist", "what is target aura blacklist",
            "what is focus aura blacklist", "what is boss aura blacklist", "what is arena aura blacklist",
            "player aura blacklist summary", "target aura blacklist summary",
            "focus aura blacklist summary", "boss aura blacklist summary", "arena aura blacklist summary",
        },
        ...
        run = function(args)
            ...
            if scope ~= "player" and scope ~= "target" and scope ~= "focus" and scope ~= "boss" and scope ~= "arena" then
                return false, "Choose Player, Target, Focus, Boss, or Arena so I know which native hidden-aura list to show."
            end
