...
local GROUP_COPY_EXCLUDE = WordSet([[offsetX offsetY point positionMode positionMigrationCount _hlMigrated
anchorMode anchorPoint anchorToFrame customAnchorFrame attachGap attachOffset raidManagerMode]])
