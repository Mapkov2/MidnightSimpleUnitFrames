...
$assistantOrderSha256 = "6D93B5BB79D3EDAFDF14D2838216E6ACEE814645ED37AFDEFB28863A9F232A39"
...
$sourceMenuRoot = Join-Path $repoRoot "MidnightSimpleUnitFrames\Shell\Menu2"
...
$sourceV2Artifacts = @(Get-ChildItem -LiteralPath (Join-Path $repoRoot "MidnightSimpleUnitFrames"), $assistantSourceRoot -Recurse -Force |
...
$explicitExclusions = @(
    ...
    "MidnightSimpleUnitFrames/Shell/Menu2/Assistant",
    "MidnightSimpleUnitFrames/Shell/Menu2/MSUF_Menu2_AssistantRuntime.xml",
    "MidnightSimpleUnitFrames/Shell/Menu2/MSUF_Menu2_AssistantDialogLocale.lua",
    "MidnightSimpleUnitFrames/Shell/Menu2/MSUF_Menu2_AssistantDialogLocale_Data.lua"
)
...
Write-Host "Validated ${zipPath}: two addons, two stamped TOCs, exact $assistantScriptCount-script Assistant V1 LoD manifest, and no core Assistant/V2/Graphify/backup/local artifacts."
