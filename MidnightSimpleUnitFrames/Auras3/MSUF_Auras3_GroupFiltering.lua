--- Auras3/MSUF_Auras3_GroupFiltering.lua - shared group aura filter engine
...
--- Declassified spells have readable spellIds even on other players.
--- These are the only spells that can be blacklisted safely.
--- Non-declassified spellIds are secret - pass through Tier 2 unfiltered.
---
--- Pattern: shared with the unit-frame aura blacklist, adapted for GF context.
local _, MSUF = ...
...
--- These spellIds are NOT secret in 12.0 because Blizzard exposes them.
...
---
local PUBLIC_AURA_PRESET_SPELLS = {
    PRESERVATION_EVOKER = {
    ...
    RAID_BUFFS = {
        [1459] = true, [6673] = true, [21562] = true,
        [369459] = true, [462854] = true, [474754] = true,
    },
    BLESSING_BRONZE = {
...
local PUBLIC_AURA_PRESET_META = {
    { key = "RAID_BUFFS", label = "Midnight Long-term Raid Buffs",
      tooltip = "Arcane Intellect, Battle Shout, Fortitude, Source of Magic, Skyfury, Symbiotic Relationship." },
    { key = "PRESERVATION_EVOKER", label = "Midnight Healer - Preservation Evoker",
      tooltip = "Dream Breath, Echo, Reversion, Lifebind." },
    { key = "AUGMENTATION_EVOKER", label = "Midnight Healer - Augmentation Evoker",
      tooltip = "Blistering Scales, Ebon Might, Prescience, Shifting Sands." },
    { key = "RESTO_DRUID", label = "Midnight Healer - Restoration Druid",
      tooltip = "Rejuvenation, Regrowth, Lifebloom, Wild Growth, Germination." },
    { key = "DISC_PRIEST", label = "Midnight Healer - Discipline Priest",
      tooltip = "Power Word: Shield, Atonement, Void Shield." },
    { key = "HOLY_PRIEST", label = "Midnight Healer - Holy Priest",
      tooltip = "Renew, Prayer of Mending, Echo of Light." },
    { key = "MISTWEAVER_MONK", label = "Midnight Healer - Mistweaver Monk",
      tooltip = "Soothing Mist, Renewing Mist, Enveloping Mist, Aspect of Harmony." },
    { key = "RESTO_SHAMAN", label = "Midnight Healer - Restoration Shaman",
      tooltip = "Earth Shield and Riptide." },
    { key = "HOLY_PALADIN", label = "Midnight Healer - Holy Paladin",
      tooltip = "Beacon and Eternal Flame variants." },
    { key = "BLESSING_BRONZE", label = "Midnight Blessing of the Bronze",
      tooltip = "All class-specific Blessing of the Bronze variants." },
    { key = "SELF_BUFFS", label = "Midnight Long-term Self Buffs",
      tooltip = "Rite of Sanctification and Rite of Adjuration." },
    { key = "ROGUE_POISONS", label = "Midnight Rogue Poisons",
      tooltip = "Deadly, Wound, Crippling, Numbing, Instant, Atrophic, Amplifying." },
    { key = "SHAMAN_IMBUE", label = "Midnight Shaman Imbuements",
      tooltip = "Windfury, Flametongue, Earthliving, Tidecaller's Guard, Thunderstrike Ward." },
    { key = "RESOURCE_AURAS", label = "Midnight Resource-like Auras",
      tooltip = "Mage Icicles and Hunter Tip of the Spear." },
    { key = "COOLDOWNS", label = "Midnight Cooldowns",
      tooltip = "Hearthstone and Shaman Reincarnation. Mythic+ teleports are not listed by Wowhead." },
}
...
AuraFilter.PUBLIC_AURA_PRESET_SPELLS = PUBLIC_AURA_PRESET_SPELLS
AuraFilter.PUBLIC_AURA_PRESET_META   = PUBLIC_AURA_PRESET_META
...
MSUF.AuraCore.Filters = AuraFilter
local A3 = MSUF.MSUF_Auras3 or _G.MSUF_Auras3
if type(A3) == "table" then
    A3.Filters = AuraFilter
end
