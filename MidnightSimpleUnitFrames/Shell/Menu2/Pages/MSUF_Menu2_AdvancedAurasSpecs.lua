...
M.AdvancedAurasSpecs = {
    AURA_SCOPES = VTP "shared=Shared|player=Player|target=Target|focus=Focus|boss1=Boss 1|boss2=Boss 2|boss3=Boss 3|boss4=Boss 4|boss5=Boss 5",
    AURA_GROWTH = VTP "RIGHT=Grow Right|LEFT=Grow Left|UP=Vertical Up|DOWN=Vertical Down",
    AURA_ROW_WRAP = VTP "DOWN=2nd row down|UP=2nd row up",
    AURA_STACK_ANCHORS = VTP "TOPLEFT=Top Left|TOPRIGHT=Top Right|BOTTOMLEFT=Bottom Left|BOTTOMRIGHT=Bottom Right",
...
ROGUE_NONLETHAL=Non-Lethal Poison (Rogue)
    ...
    PANDEMIC_MODES = VTP "BORDER=Border|PULSE=Pulse|GLOW=Glow",
}
