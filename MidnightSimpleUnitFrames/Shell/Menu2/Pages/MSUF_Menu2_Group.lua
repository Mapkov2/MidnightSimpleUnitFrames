...
local GF_COPY_CATEGORIES = {
    ...
    { key = "border", label = "Background & Opacity", keys = WL [[bgR bgG bgB bgA hpBarAlpha hpBgAlpha hpTextIgnoreAlpha alphaSync alphaSyncBoth alphaExcludeTextPortrait alphaLayerMode alphaInCombat alphaOutOfCombat alphaFGInCombat alphaFGOutOfCombat alphaBGInCombat alphaBGOutOfCombat alphaHPInCombat alphaHPOutOfCombat alphaPreserveHPColor]] },
    { key = "range", label = "Range Fade", keys = WL [[rangeFadeEnabled rangeFadeAlpha rangeFadeLayerMode offlineAlpha alphaPreserveHPColor]] },
