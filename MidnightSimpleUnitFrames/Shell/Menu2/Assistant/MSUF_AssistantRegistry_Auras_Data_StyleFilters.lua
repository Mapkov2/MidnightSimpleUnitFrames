...
Data.AURA_FILTER_BOOLEAN_SPECS = {
    ...
    { lane = "buff", key = "cancelable", label = "Buff Cancelable Filter", words = { "buff cancelable filter", "cancelable buffs", "cancellable buffs", "show cancelable buffs", "show cancellable buffs" } },
    { lane = "buff", key = "notCancelable", label = "Buff Not Cancelable Filter", words = { "buff not cancelable filter", "not cancelable buffs", "not cancellable buffs", "uncancelable buffs", "uncancellable buffs", "show non cancelable buffs" } },
