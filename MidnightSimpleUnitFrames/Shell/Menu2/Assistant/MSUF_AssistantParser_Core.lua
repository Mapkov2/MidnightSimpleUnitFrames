...
local function Normalize(text)
    ...
    text = text:gsub("%f[%w]wat%f[%W]", "what")
    text = text:gsub("%f[%w]whta%f[%W]", "what")
    text = text:gsub("%f[%w]wich%f[%W]", "which")
    ...
    text = text:gsub("%f[%w]exprot%f[%W]", "export")
    text = text:gsub("%f[%w]copie%f[%W]", "copy")
    text = text:gsub("seperat", "separat")
    text = text:gsub("delimeter", "delimiter")
    text = text:gsub("heigth", "height")
    text = text:gsub("hieght", "height")
    text = text:gsub("hight", "height")
    text = text:gsub("%f[%w]widht%f[%W]", "width")
    text = text:gsub("%f[%w]widh%f[%W]", "width")
    text = text:gsub("%f[%w]opactiy%f[%W]", "opacity")
    text = text:gsub("%f[%w]opacitiy%f[%W]", "opacity")
    text = text:gsub("%f[%w]transparancy%f[%W]", "transparency")
    text = text:gsub("%f[%w]transparant%f[%W]", "transparent")
    ...
    text = text:gsub("%f[%w]dispellable%f[%W]", "dispellable")
    text = text:gsub("%f[%w]dispelable%f[%W]", "dispellable")
    text = text:gsub("%f[%w]dispellabe%f[%W]", "dispellable")
    text = text:gsub("%f[%w]dispellble%f[%W]", "dispellable")
    text = text:gsub("%f[%w]felher%f[%W]", "fehler")
    text = text:gsub("%f[%w]profie%f[%W]", "profile")
    text = text:gsub("%f[%w]porfile%f[%W]", "profile")
    text = text:gsub("%f[%w]restar%f[%W]", "restore")
    text = text:gsub("%f[%w]resotre%f[%W]", "restore")
    ...
    text = text:gsub("%f[%w]bufs%f[%W]", "buffs")
    text = text:gsub("%f[%w]bufff%f[%W]", "buff")
