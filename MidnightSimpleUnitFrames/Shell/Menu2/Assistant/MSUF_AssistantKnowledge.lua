...
local PAGE_HELP = {
    ...
    auras3_filters = { title = "Aura Filters help", lines = { "You can change registered Aura filter toggles, prepared blacklist entries, public group-aura category blacklists, and Aura quick presets. Aura copy remains blocked until that backend is registered.", "Examples: blacklist spell 12345 for player auras; show raid buff category blacklist; apply performance aura preset." }, actions = { "Open Aura Filters" } },
