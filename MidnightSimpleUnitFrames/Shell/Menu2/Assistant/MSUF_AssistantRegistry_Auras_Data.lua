...
Data.GF_AURA_FILTER_VALUES = {
    buff = { "ALL", "PLAYER", "RAID", "RAID_IN_COMBAT", "INCLUDE_NAME_PLATE_ONLY", "CANCELABLE", "NOT_CANCELABLE", "EXTERNAL_DEFENSIVE", "BIG_DEFENSIVE" },
    debuff = { "ALL", "PLAYER", "RAID", "RAID_IN_COMBAT", "INCLUDE_NAME_PLATE_ONLY", "RAID_PLAYER_DISPELLABLE", "CROWD_CONTROL" },
}
Data.GF_AURA_FILTER_ALIASES = {
    ...
    ["not cancelable"] = "NOT_CANCELABLE",
    ["not cancellable"] = "NOT_CANCELABLE",
    ["non cancelable"] = "NOT_CANCELABLE",
    ["non cancellable"] = "NOT_CANCELABLE",
    uncancelable = "NOT_CANCELABLE",
    uncancellable = "NOT_CANCELABLE",
    ["not cancelable buffs"] = "NOT_CANCELABLE",
    ["not cancellable buffs"] = "NOT_CANCELABLE",
    ["non cancelable buffs"] = "NOT_CANCELABLE",
    ["non cancellable buffs"] = "NOT_CANCELABLE",
    ["uncancelable buffs"] = "NOT_CANCELABLE",
    ["uncancellable buffs"] = "NOT_CANCELABLE",
