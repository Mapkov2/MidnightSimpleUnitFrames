...
local UNIT_CASTBAR_GENERAL_KEYS = {
    player = WL("enablePlayerCastbar castbarPlayerBackend castbarPlayerBackendBeforeHide showPlayerCastTime castbarPlayerShowIcon castbarPlayerShowSpellName castbarPlayerTimeFormat"),
    target = WL("enableTargetCastbar castbarTargetBackend castbarTargetBackendBeforeHide showTargetCastTime castbarTargetShowIcon castbarTargetShowSpellName castbarTargetTimeFormat"),
    focus = WL("enableFocusCastbar castbarFocusBackend castbarFocusBackendBeforeHide showFocusCastTime castbarFocusShowIcon castbarFocusShowSpellName castbarFocusTimeFormat"),
    boss = WL("enableBossCastbar bossCastbarBackend bossCastbarBackendBeforeHide showBossCastTime showBossCastIcon showBossCastName bossCastTimeFormat"),
}
...
local FONT_GENERAL_KEYS = KS("fontKey", "boldText", "noOutline", "textBackdrop", "nameClassColor", "npcNameRed", "colorPowerTextByType", "colorHealthTextByHealth")

local FONT_SCOPE_KEYS = KSW [[
    fontOverride fontKey boldText noOutline textBackdrop nameClassColor npcNameRed colorPowerTextByType colorHealthTextByHealth
