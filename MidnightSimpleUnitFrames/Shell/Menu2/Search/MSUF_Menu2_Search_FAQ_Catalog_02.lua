...
if type(Data.RegisterFAQProvider) == "function" then
    Data.RegisterFAQProvider(function(env)
        ...
        },
        {
            ...
            },
            {
                ...
                a = "Use Group Frames pages: Layout for size/growth/sorting, Health & Text for bars/text, Auras for" ..
                    " Buff/Debuff placement, and Indicators for status icons.",
                p = "gf_layout",
                t = "Opens: Group Frames > Layout",
                x = "Group Frames Layout Health & Text Auras Buffs Debuffs Indicators party raid growth sorting",
                k = SearchKeywordList(
        ...
        },
        {
            ...
            { "How do I add or change status icons and indicators?", "Unit frame status icons are on each unit page. Group frame indicators are in Group Frames > Indicators.", "gf_indicators", "Opens: Group Frames > Indicators", "Indicators Status Icons Spell Indicators Corner Indicators role icon dispel aggro raid marker", SearchKeywordList(SEARCH_DISPEL_DEBUFF_KEYWORDS, SEARCH_HIGHLIGHT_BORDER_KEYWORDS, "status icons|indicator|indicators|corner indicator|spell indicator|raid marker|role icon|leader icon|ready check|aggro icon|threat icon|focus glow"), 190, },
        },
        {
            {
