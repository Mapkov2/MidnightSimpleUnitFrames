...
dispel=dispel border|dispel overlay|dispellable debuffs|dispel border detects|any dispel-type debuff|any debuff|magic|curse|poison|disease|cleanse|decurse|group indicators|highlight borders
...
tank|dps=role icon|group indicators|sorting
...
readycheck|bereitschaft=ready check|status icons|group indicators
