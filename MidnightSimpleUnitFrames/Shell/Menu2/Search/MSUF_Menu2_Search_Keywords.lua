...
Data.KEYWORDS = {
    ...
    opt_misc = "global style miscellaneous misc language localization localisation locale translation range fade range check range checker distance check out of range unit frame range check ui behavior tooltip tooltips unitframe tooltip group frame tooltip mouseover tooltip modifier tooltip combat settings general blizzard frames default frames hide blizzard disable blizzard minimap minimap icon target sounds version check startup notices menu behavior snap edge snap",
