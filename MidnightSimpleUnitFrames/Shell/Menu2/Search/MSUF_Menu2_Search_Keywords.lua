...
Data.KEYWORDS = {
    ...
    auras3_buffs = "aura style styling colors text stack stacks cooldown timer colors cooldown text stack count font size anchor offset buffs cooldown swipe",
    auras3_debuffs = "aura style styling colors text stack stacks cooldown timer colors cooldown text stack count font size anchor offset debuffs cooldown swipe",
    auras3_rendering = "aura style styling colors text stack stacks cooldown timer colors cooldown text stack count font size anchor offset buffs debuffs cooldown swipe",
