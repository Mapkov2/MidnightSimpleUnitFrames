...
Data.KEYWORDS = {
    ...
    auras3 = "auras buffs buff enable enabled visibility aura scope group frame auras unit auras click through clickthrough aura position",
    auras3_buffs = "auras buffs buff enable enabled visibility aura scope group frame auras unit auras click through clickthrough aura position",
    auras3_debuffs = "auras debuffs debuff enable enabled visibility aura scope group frame auras unit auras click through clickthrough aura position dispel dispellable harmful",
