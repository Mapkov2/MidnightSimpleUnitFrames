    ...
    local function ApplyAggroOutlineEventRegistration()
        ...
        if want then
            ...
            do
                ...
                -- Exported for consolidated TARGET_CHANGED handler in UFCore
                _G.MSUF_AggroOutline_OnTargetChanged = function()
            ...
            _G.MSUF_AggroOutline_OnTargetChanged = nil
        end
    end
    ...
    local function ApplyDispelOutlineEventRegistration()
        ...
        if want then
            ...
            do
                ...
                _G.MSUF_DispelOutline_OnTargetChanged = function()
            ...
            _G.MSUF_DispelOutline_OnTargetChanged = nil
        end
    end
