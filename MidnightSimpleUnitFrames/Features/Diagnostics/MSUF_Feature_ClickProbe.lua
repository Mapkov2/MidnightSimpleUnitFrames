...
local function Report()
    ...
    if #list == 0 then
        print("  no MSUF OnEvent work ran during the window -- the spike is not event-driven; report this.")
    end
...
local function IdReport()
    ...
    if #list == 0 then
        print("  no element work ran -- the spike is outside the identity elements; report this.")
    end
