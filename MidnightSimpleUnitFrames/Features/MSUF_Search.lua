...
local INDEX = {
    ...
    -- Portrait Styling (per-unit Unit Frame Portrait section)
    { label="Portrait Shape (Square / Circle)",
      hint="Player > Portrait", pageKey="uf_player",anchor="MSUF_UF_PortraitShapeDrop",
    ...
    { label="Portrait Border (None / Solid / Class Color / Reaction / Custom)",
      hint="Unit Frame > Portrait", pageKey="uf_player",anchor="MSUF_UF_PortraitDropDown",
    ...
    { label="Portrait Size Override",
      hint="Unit Frame > Portrait", pageKey="uf_player",anchor="MSUF_UF_PortraitSizeSlider",
      keywords={"portrait size","portrait größe","custom size","size override","portrait dimension"} },
    { label="Portrait Offset (X / Y)",
      hint="Unit Frame > Portrait", pageKey="uf_player",anchor="MSUF_UF_PortraitOffsetXSlider",
    ...
    { label="Class Portrait Style (Blizzard / Rondo Colored / Rondo WoW)",
      hint="Unit Frame > Portrait", pageKey="uf_player",anchor="MSUF_UF_PortraitClassStyleDrop",
