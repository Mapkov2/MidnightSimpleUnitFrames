...
gf_main={title="MSUF Group Frames",build=function() local fn=_G.MSUF_EnsureGFPanelBuilt if type(fn)=="function" then return fn() end return nil end},gf_party={title="MSUF Group Frames (Party)",build=function() local fn=_G.MSUF_EnsureGFPanelBuilt if type(fn)=="function" then return fn() end return nil end},gf_raid={title="MSUF Group Frames (Raid)",build=function() local fn=_G.MSUF_EnsureGFPanelBuilt if type(fn)=="function" then return fn() end return nil end},
...
then highlightKey="hdr_options"elseif activeKey:match("^gf_") then highlightKey="hdr_groupframes"elseif activeKey=="modules"then highlightKey="hdr_modules"end
end
end
end
...
gf_main={2,2},gf_party={3,2},gf_raid={4,2},
}
...
gf_main={0.35,0.85,0.55},gf_party={0.35,0.85,0.55},gf_raid={0.35,0.85,0.55},
}
