...
AddRuntimeReasonMasks(runtimeReasonMasks, MASK_DISPEL_VISUAL,
  "MSUF2_DISPEL_BORDER MSUF2_DISPEL_TRIGGER MSUF2_DISPEL_COLOR_MODE MSUF2_UF_DISPEL_OVERLAY " ..
  "MSUF2_UF_DISPEL_OVERLAY_TRIGGER MSUF2_UF_DISPEL_OVERLAY_STYLE " ..
  "MSUF2_UF_DISPEL_OVERLAY_HEALTH MSUF2_UF_DISPEL_OVERLAY_ALPHA MSUF2_UF_DISPEL_OVERLAY_COLOR")
...
AddRuntimeReasonMasks(runtimeReasonMasks, MASK_POWER,
  ...
  "MSUF2_POWER_SMOOTH MSUF2_POWER_DETACHED MSUF2_POWER_DETACHED_TEXT " ..
