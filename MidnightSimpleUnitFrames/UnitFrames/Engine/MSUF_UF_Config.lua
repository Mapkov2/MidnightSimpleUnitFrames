...
local function ResolveUnit(db, unit, out)
    ...
    out.health.barGradient = ResolveBarGradient(conf, general, "enableGradient")
    ...
    out.power.borderR = Number(ScopedValue(conf, general, "barOutlineColorR", general.barBorderR), 0)
    out.power.borderG = Number(ScopedValue(conf, general, "barOutlineColorG", general.barBorderG), 0)
    out.power.borderB = Number(ScopedValue(conf, general, "barOutlineColorB", general.barBorderB), 0)
    out.power.borderA = Number(ScopedValue(conf, general, "barOutlineColorA", general.barBorderA), 1)
    ...
    out.power.barGradient = ResolveBarGradient(conf, general, "enablePowerGradient")
    ...
    out.dispel.r = Number(general.hlDispelColorR or general.dispelBorderColorR, 0.25)
    out.dispel.g = Number(general.hlDispelColorG or general.dispelBorderColorG, 0.75)
    out.dispel.b = Number(general.hlDispelColorB or general.dispelBorderColorB, 1)
    out.dispel.a = 1
    ...
    out.border.r = Number(ScopedValue(conf, general, "barOutlineColorR", general.barBorderR), 0)
    out.border.g = Number(ScopedValue(conf, general, "barOutlineColorG", general.barBorderG), 0)
    out.border.b = Number(ScopedValue(conf, general, "barOutlineColorB", general.barBorderB), 0)
    out.border.a = Number(ScopedValue(conf, general, "barOutlineColorA", general.barBorderA), 1)
    ...
    out.border.aggroR = Number(general.hlAggroColorR or general.aggroBorderColorR or general.aggroBorderR, 1.00)
    out.border.aggroG = Number(general.hlAggroColorG or general.aggroBorderColorG or general.aggroBorderG, 0.55)
    out.border.aggroB = Number(general.hlAggroColorB or general.aggroBorderColorB or general.aggroBorderB, 0.00)
    out.border.purgeR = Number(general.hlPurgeColorR or general.purgeBorderColorR, 1.00)
    out.border.purgeG = Number(general.hlPurgeColorG or general.purgeBorderColorG, 0.85)
    out.border.purgeB = Number(general.hlPurgeColorB or general.purgeBorderColorB, 0.00)
