...
MidnightSimpleUnitFrames/UnitFrames/Core/Group/MSUF_UF_Group_AuraCache.lua
MidnightSimpleUnitFrames/UnitFrames/Core/Group/MSUF_UF_Group_Visuals.lua
MidnightSimpleUnitFrames/UnitFrames/Core/Group/MSUF_UF_Group_Runtime.lua
```
...
```text
UnitFrames/Core/Group/MSUF_UF_Group_Runtime.lua ScanHeader spike
Auras3/MSUF_Auras3_UnitFrames.lua UNIT_AURA bridge
Core/MSUF_Borders.lua FlushDispelAuraUnits
Core/MSUF_Borders.lua HasDispellableDebuff
UnitFrames/Core/Group/MSUF_UF_Group_Visuals.lua GroupVisuals
UnitFrames/Core/Group/MSUF_UF_Group_Auras.lua GroupAuraLanes
...
- `UnitFrames/Core/Group/MSUF_UF_Group_Visuals.lua GroupVisuals` should stay
  event-only and avoid OnUpdate work.
- `UnitFrames/Core/Group/MSUF_UF_Group_AuraCache.lua GroupAuraCache` should be
  the only group path calling `C_UnitAuras.GetAuraSlots`.
- `UnitFrames/Core/Group/MSUF_UF_Group_Runtime.lua ScanHeader` should stay out
  of unit-event hotpaths.
