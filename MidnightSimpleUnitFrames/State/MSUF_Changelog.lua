...
local data = {
    currentVersion = "6.0-Beta29",
    previousVersion = "6.0-Beta28",
    rangeLabel = "6.0-Beta28 -> 6.0-Beta29",
    entries = {
        {
            version = "6.0-Beta29",
            date = "2026-07-25",
            sections = {
                ...
                },
                {
                    ...
                    bullets = {
                        ...
                        "Expanded the Core Lua 5.1 suite to 162 passing tests, including new aura border style, slash-command registry, and unit copy coverage regressions.",
                    },
                },
            },
        },
