...
local function EnsureDriverCallbacks(frame)
    ...
    frame._msufStopCB_chanT1 = function()
        ...
        C_Timer.After(frame._msufStopT2 or CHANNEL_STOP_SECOND_DELAY_MIN, frame._msufStopCB_chanT2)
    end
...
local function ScheduleStopConfirmation(frame, castType)
    ...
    frame._msufStopTimer1 = true
    C_Timer.After(STOP_CONFIRM_FIRST_DELAY, frame._msufStopCB_castT1)
    frame._msufStopTimer3 = true
    C_Timer.After(STOP_CONFIRM_CAST_FAILSAFE, frame._msufStopCB_failsafe)
end
