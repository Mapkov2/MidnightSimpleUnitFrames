--- TBC Classic target DoT aura IDs.
--- Baseline: WeakAuras TBC templates and ElvUI TBC filters, 2026-08-02.
local _, MSUF = ...
MSUF = MSUF or (_G.MSUF_NS) or {}
local A3 = MSUF.MSUF_Auras3
if type(A3) ~= "table" then A3 = {}; MSUF.MSUF_Auras3 = A3 end

A3.TargetDotDataVersion = "TBC-2.5.6.68941"
A3.TargetDotData = {
    DRUID = {
    ...
    HUNTER = {
        ...
        { 19386, "Wyvern Sting" }, { 24131, "Wyvern Sting" },
    },
    MAGE = {
    ...
    WARLOCK = {
        ...
        { 18265, "Siphon Life" }, { 27243, "Seed of Corruption" },
        { 30108, "Unstable Affliction" },
    },
    WARRIOR = {
        { 772, "Rend" }, { 12721, "Deep Wounds" },
    },
}
