            ...
            sections = {
                {
                    ...
                    bullets = {
                        ...
                        "Unit Frame heal prediction: Heal prediction now uses the same incoming-heal overlay path across Unit Frames, supports non-player Unit Frames, and hides early when the feature is disabled.",
                ...
                },
                {
                    ...
                    bullets = {
                        ...
                        "Fixed Group Frame Dispel Glow continuing to show when the selected Group Frame scope uses Blizzard's native aura renderer.",
                        "Fixed highlight preview toggles so aggro, dispel, purge, and boss-target border tests respect the current Bars scope and disabled outline modes.",
                        "Restored combat-safe Group Frame range-fade alpha targeting while keeping the visual bar group as the out-of-combat alpha target.",
                ...
                },
                {
                    ...
                    bullets = {
                        "Added the release helper scripts/UI for preparing release notes, package builds, GitHub releases, Wago updates, and CurseForge publishing from one workflow.",
                        "Added tools/MSUF-AutoChangelog.ps1 / .cmd to refresh managed changelog blocks from commits and current working-tree changes, with optional in-game changelog regeneration.",
                        "Added tools/update-addon-changelog.ps1 to generate the bundled in-game changelog data from CHANGELOG.md.",
