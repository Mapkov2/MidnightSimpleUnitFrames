...
local PARTY_DEFAULTS = {
    ...
    targetedSpellsTextSafeR = 1.00,
    targetedSpellsTextSafeG = 1.00,
    targetedSpellsTextSafeB = 1.00,
    targetedSpellsTextWarningR = 1.00,
    targetedSpellsTextWarningG = 0.85,
    targetedSpellsTextWarningB = 0.20,
    targetedSpellsTextUrgentR = 1.00,
    targetedSpellsTextUrgentG = 0.55,
    targetedSpellsTextUrgentB = 0.10,
    --- Grid layout
    unitsPerColumn    = 5,
    maxColumns        = 1,
