...
SI.SpecDefaults = {
    RestorationDruid = {
        Rejuvenation = { placed = { type = "icon",   anchor = "TOPLEFT",     x = 1, y = -1, size = 18 } },
        Regrowth     = { placed = { type = "icon",   anchor = "TOPRIGHT",    x = -1, y = -1, size = 18 } },
        Lifebloom    = { placed = { type = "icon",   anchor = "BOTTOMLEFT",  x = 1, y = 1, size = 18 } },
        WildGrowth   = { placed = { type = "square", anchor = "BOTTOMRIGHT", x = -3, y = 3, size = 6 } },
        Germination  = { placed = { type = "square", anchor = "BOTTOM",      x = 0, y = 3, size = 6 } },
        IronBark     = { frame = { type = "border",  color = {0.65, 0.47, 0.33, 1}, priority = 1 } },
    },
    DisciplinePriest = {
        Atonement       = { placed = { type = "square", anchor = "TOPLEFT", x = 2, y = -2, size = 8 },
                            frame = { type = "healthtint", color = {0.94, 0.82, 0.31, 0.20}, priority = 5 } },
        PowerWordShield = { placed = { type = "icon",   anchor = "TOPRIGHT", x = -1, y = -1, size = 18 } },
        PrayerOfMending = { placed = { type = "icon",   anchor = "BOTTOMLEFT", x = 1, y = 1, size = 16 } },
        PainSuppression = { frame = { type = "border",  color = {0.81, 0.58, 0.93, 1}, priority = 1 } },
    },
    HolyPriest = {
        Renew           = { placed = { type = "icon",   anchor = "TOPLEFT", x = 1, y = -1, size = 18 } },
        PrayerOfMending = { placed = { type = "icon",   anchor = "TOPRIGHT", x = -1, y = -1, size = 16 } },
        EchoOfLight     = { placed = { type = "square", anchor = "BOTTOMLEFT", x = 2, y = 2, size = 6 } },
        GuardianSpirit  = { frame = { type = "border",  color = {0.94, 0.50, 0.50, 1}, priority = 1 } },
    },
    PreservationEvoker = {
        Echo         = { placed = { type = "icon", anchor = "TOPLEFT",    x = 1, y = -1, size = 18 },
                         frame = { type = "namecolor", color = {0.31, 0.76, 0.97, 1}, priority = 5 } },
        Reversion    = { placed = { type = "icon", anchor = "TOPRIGHT",   x = -1, y = -1, size = 18 } },
        DreamBreath  = { placed = { type = "icon", anchor = "BOTTOMLEFT", x = 1, y = 1, size = 16 } },
        Lifebind     = { placed = { type = "square", anchor = "CENTER",   x = 0, y = 0, size = 8 } },
    },
    AugmentationEvoker = {
        EbonMight    = { placed = { type = "icon", anchor = "TOPLEFT",  x = 1, y = -1, size = 20 },
                         frame = { type = "healthtint", color = {0.62, 0.47, 0.85, 0.20}, priority = 5 } },
        Prescience   = { placed = { type = "icon", anchor = "TOPRIGHT", x = -1, y = -1, size = 20 },
                         frame = { type = "namecolor", color = {0.81, 0.58, 0.85, 1}, priority = 5 } },
        BlisteringScales = { placed = { type = "square", anchor = "BOTTOMRIGHT", x = -3, y = 3, size = 6 } },
    },
    MistweaverMonk = {
        RenewingMist   = { placed = { type = "icon", anchor = "TOPLEFT",    x = 1, y = -1, size = 18 } },
        EnvelopingMist = { placed = { type = "icon", anchor = "TOPRIGHT",   x = -1, y = -1, size = 18 } },
        SoothingMist   = { placed = { type = "icon", anchor = "BOTTOMLEFT", x = 1, y = 1, size = 16 } },
        LifeCocoon     = { frame = { type = "border", color = {0.31, 0.76, 0.97, 1}, priority = 1 } },
    },
    RestorationShaman = {
        Riptide     = { placed = { type = "icon", anchor = "TOPLEFT",  x = 1, y = -1, size = 18 } },
        EarthShield = { placed = { type = "icon", anchor = "TOPRIGHT", x = -1, y = -1, size = 18 } },
        EarthlivingWeapon = { placed = { type = "square", anchor = "BOTTOMLEFT", x = 2, y = 2, size = 6 } },
    },
    HolyPaladin = {
