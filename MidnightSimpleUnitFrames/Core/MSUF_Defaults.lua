...
do
    ...
    -- Text formatting globals (inherited by GF when nil)
    if g.hidePercentSymbol == nil then g.hidePercentSymbol = false end
    if g.useShortNumbers == nil then g.useShortNumbers = true end
