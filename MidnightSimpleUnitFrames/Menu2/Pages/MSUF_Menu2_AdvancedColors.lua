...
local function ApplyColors()
    ...
    if MSUF and type(MSUF.MSUF_ApplyGameplayVisuals) == "function" then pcall(MSUF.MSUF_ApplyGameplayVisuals) end
...
local function BuildColors(ctx)
    ...
    ButtonAt(background, "Reset to black", 12, -184, 140, function()
