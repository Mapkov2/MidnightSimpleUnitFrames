...
local function BuildLayout(ctx, builder, unit)
    ...
    local anchorChoices = {
        ...
        { value = "EssentialCooldownViewer", text = "Essential cooldown viewer" },
        { value = "UtilityCooldownViewer", text = "Utility cooldown viewer" },
        { value = "BuffIconCooldownViewer", text = "Tracked buffs viewer" },
    ...
    local anchorTo = W.Dropdown(sec, "Anchor unit to", AnchorValues, 230)
...
local function BuildUnitPage(info)
    return function(ctx)
        ...
        if type(M.BuildAuras3UnitSection) == "function" then
