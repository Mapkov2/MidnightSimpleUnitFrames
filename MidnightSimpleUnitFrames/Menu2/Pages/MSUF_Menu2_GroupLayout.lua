...
local function BuildGFLayout(ctx)
    ...
    local hideOfflineCombat = BindScopeToggle(ctx, W.ToggleAt(general, "Hide offline in combat", generalRightX, -240, generalRightToggleW), "hideOfflineInCombat", false, "visual")
