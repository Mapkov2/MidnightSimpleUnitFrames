...
local ContentMetrics = SearchText.ContentMetrics
local ContentWidth = SearchText.ContentWidth
local ContentHeight = SearchText.ContentHeight
local TrimText = SearchText.TrimText
local ShortLabel = SearchText.ShortLabel
local SearchPlaceholderText = SearchText.SearchPlaceholderText
local SearchBoxHasText = SearchText.SearchBoxHasText
local RefreshSearchPlaceholder = SearchText.RefreshSearchPlaceholder
local UpdateSearchPlaceholder = SearchText.UpdateSearchPlaceholder
local NormalizeSearchText = SearchText.NormalizeSearchText
local DisplaySearchText = SearchText.DisplaySearchText
local IsSearchLocaleKey = SearchText.IsSearchLocaleKey
local SearchEffectiveLocale = SearchText.SearchEffectiveLocale
local SearchLocaleTranslations = SearchText.SearchLocaleTranslations
local SearchDisplayText = SearchText.SearchDisplayText
local AddSearchText = SearchText.AddSearchText
local AddSearchTextVariants = SearchText.AddSearchTextVariants
local AddRawSearchText = SearchText.AddRawSearchText
local SearchTextVariants = SearchText.SearchTextVariants
local ForEachLocaleSearchPattern = SearchText.ForEachLocaleSearchPattern
local AddSearchPatternText = SearchText.AddSearchPatternText
local AddSearchValuePatternText = SearchText.AddSearchValuePatternText
local AddToggleQuestionSearchText = SearchText.AddToggleQuestionSearchText
...
local SEARCH_KIND_ACTION_KEYWORDS = SearchText.KIND_ACTION_KEYWORDS or {}
local SEARCH_KIND_PATTERNS = SearchText.KIND_PATTERNS or {}
...
AppendSearchKeywords("auras3", SEARCH_UNIT_AURA_DISPEL_KEYWORDS)
AppendSearchKeywords("auras3", SEARCH_DISPEL_DEBUFF_KEYWORDS)
