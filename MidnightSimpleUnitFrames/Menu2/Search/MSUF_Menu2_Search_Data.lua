...
Data.KEYWORDS = {
    ...
    auras3 = "auras overview aura scope global style unit auras group frame auras buffs debuffs icon size caps rows spacing sorting cooldown timer text tooltip private aura filter override dispel stealable only mine own buffs own debuffs pandemic reminders click through clickthrough aura position aura size",
    auras3_rendering = "aura rendering renderer blizzard custom msuf custom native blizzard aura display mode group frame auras buffs debuffs dispels defensives private auras route routing ownership use blizzard msuf dispel highlights cooldown text strata frame level organization icon size unit aura enable enabled",
    ...
    auras3_styling = "aura styling style colors text stack stacks cooldown timer colors cooldown text stack count font size anchor safe warning urgent own buff own debuff group frame custom aura style buffs debuffs defensives masque dynamic scale cooldown swipe",
    auras3_private = "private auras private aura player private aura group frame private auras blizzard private aura ownership countdown numbers private aura max size anchor growth placement",
...
function Data.BuildFAQ(env)
    ...
    },
    {
        ...
        answer = "Blizzard mode lets WoW place the selected aura types. MSUF Custom mode lets MSUF control aura size, growth, position, filters, and styling. MSUF Dispel Highlights keep Blizzard icons while allowing MSUF's dispel border and overlay visuals.",
        pageKey = "auras3_rendering",
        ...
        keywords = SearchKeywordList(SEARCH_BLIZZARD_DISPEL_KEYWORDS, SEARCH_DISPEL_DEBUFF_KEYWORDS, SEARCH_HIGHLIGHT_BORDER_KEYWORDS, {
            [0] = false,
            "keep blizzard debuffs but show dispel overlay", "blizzard dispel icons and msuf border",
        }),
        priority = 760,
    },
    {
    ...
    },
    {
        ...
        answer = "Use the Auras pages for scope, rendering, filters, styling, and private auras. Group Frames > Buffs & Debuffs still controls custom group aura placement.",
        pageKey = "auras3",
        target = "Opens: Auras > Overview",
        anchorText = "Auras Overview Rendering Filters Blacklist Styling Private Auras buffs debuffs",
    ...
    },
    {
        ...
        answer = "Open Auras > Filters & Blacklist. Unit-frame scopes support spell-ID blacklist entries; group-frame custom auras also support declassified category blacklists.",
        pageKey = "auras3_filters",
        target = "Opens: Auras > Filters & Blacklist",
    ...
    },
    {
        ...
        answer = "Use Auras > Rendering for Blizzard/MSUF ownership, Auras > Styling for text and stack presentation, and Group Frames > Buffs & Debuffs for custom icon placement.",
        pageKey = "auras3_rendering",
        target = "Opens: Auras > Rendering",
        anchorText = "Buffs Debuffs Defensives Private Auras Rendering Styling Filters Group Frames Buffs Debuffs",
    ...
    },
    {
        ...
        answer = "Open Auras > Filters & Blacklist. Check the active scope, Only Mine, boss/raid filters, dispellable filters, and blacklist entries.",
        pageKey = "auras3_filters",
        target = "Opens: Auras > Filters & Blacklist",
    ...
    },
    {
        ...
        answer = "Open the unit page > Auras to lower max buffs/debuffs, rows and icon size. Use Auras > Filters & Blacklist for filtering.",
        pageKey = "uf_player",
        target = "Opens: Player > Auras",
        anchorText = "Auras Max Buffs Max Debuffs Icon size rows spacing filters",
    ...
    },
    {
        ...
        answer = "Open Player > Auras, turn off shared visuals if needed, then set Max Buffs to 0. Show Buffs remains a shared master toggle.",
        pageKey = "uf_player",
        target = "Opens: Player > Auras > Max Buffs",
        anchorText = "Player Auras Show Buffs locked Max Buffs set to 0 hide player buffs only",
        keywords = {
    ...
    },
    {
        ...
        answer = "Open Auras > Private Auras. Player private aura settings and group-frame Blizzard ownership rules live there.",
        pageKey = "auras3_private",
        target = "Opens: Auras > Private Auras",
        anchorText = "Private Auras Player Group Frames Blizzard ownership raid mechanics",
    ...
    },
    {
        ...
        answer = "Open Auras > Styling for timer colors, stack text, cooldown text size, and group-frame custom aura text styling.",
        pageKey = "auras3_styling",
        target = "Opens: Auras > Styling",
        anchorText = "Styling Cooldown Timer Text cooldown text size safe warning urgent stack count",
    ...
    },
    {
        ...
        answer = "Open Auras > Filters & Blacklist for group-frame custom aura filters, then use Group Frames > Buffs & Debuffs for placement.",
        pageKey = "auras3_filters",
        target = "Opens: Auras > Filters & Blacklist",
    ...
    },
    {
        ...
        answer = "Open the unit page > Auras for unit-frame icon sizing. For group frames, use Auras > Styling for text and Group Frames > Buffs & Debuffs for custom icon size.",
        pageKey = "uf_player",
        target = "Opens: Player > Auras",
    ...
    },
    {
        ...
        answer = "Open Auras > Filters & Blacklist for unit spell-ID blacklists and group category blacklists. Group custom aura placement stays in Group Frames > Buffs & Debuffs.",
        pageKey = "auras3_filters",
        target = "Opens: Auras > Filters & Blacklist",
        anchorText = "Filters Blacklist custom buffs custom debuffs boss debuffs spell id private auras raid debuffs",
    ...
    },
    {
        ...
        answer = "Open Auras > Filters & Blacklist for unit-frame debuff filtering. For party/raid dispels, use Group Frames > Indicators and Auras > Rendering for Blizzard/MSUF ownership.",
        pageKey = "auras3_filters",
        target = "Opens: Auras > Filters & Blacklist",
    ...
    },
    {
        ...
        answer = "MSUF Edit Mode moves frames and supported castbars. Aura icon placement is controlled from each unit page > Auras or Group Frames > Buffs & Debuffs.",
        pageKey = "uf_player",
        target = "Opens: Player > Auras",
