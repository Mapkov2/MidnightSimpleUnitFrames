...
local SEARCH_FAQ = {
    ...
    },
    {
        ...
        answer = "Set Bar Background Tint to white and enable Custom color in Dark Mode. For one global color, keep the two follows-color toggles off.",
        pageKey = "opt_colors",
        target = "Opens: Global Style > Colors > Bar Background Tint > Custom color in Dark Mode",
        anchorText = "Bar Background Tint Custom color in Dark Mode missing health white background",
        keywords = {
    ...
    },
    {
        ...
        answer = "For bar backgrounds, open Global Style > Colors > Bar Background Tint. For white in Dark Mode, enable Custom color in Dark Mode.",
        pageKey = "opt_colors",
