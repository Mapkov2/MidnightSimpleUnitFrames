...
local function BuildDashboardUX(ctx)
    ...
    local function IsDashboardEditModeCombatLocked()
        local fn = rawget(_G, "IsEditModeCombatLocked")
        if type(fn) == "function" then return fn() and true or false end
    ...
    Feature(3, "Auras", "Shared defaults plus per-unit overrides explained inline.", "A", "auras3")
