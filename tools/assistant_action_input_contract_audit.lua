...
assert(#actions == 176, "expected 176 registered actions, got " .. tostring(#actions))
...
assert(contractCount == 176, "expected 176 explicit contracts, got " .. tostring(contractCount))
