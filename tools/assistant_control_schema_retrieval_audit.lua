...
Check(Data.collectionUnionControls == 2728 and #(Data.records or {}) == 2728,
    "reviewed 2728-control exhaustive union")
...
Check(collisionGroups == 251 and collisionRows == 2172 and maxCollision == 57,
