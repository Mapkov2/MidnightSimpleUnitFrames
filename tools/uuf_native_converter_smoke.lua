...
EqualAt(alphaOutput, "player.alphaPreserveHPColor", true)
EqualAt(alphaOutput, "player.alphaIndependentMissingHealth", true)
NearAt(alphaOutput, "player.alphaMissingHealthBase", 0.35)
...
EqualAt(defaultAlphaOutput, "target.alphaPreserveHPColor", false)
EqualAt(defaultAlphaOutput, "target.alphaIndependentMissingHealth", false)
NearAt(defaultAlphaOutput, "target.alphaMissingHealthBase", 1)
