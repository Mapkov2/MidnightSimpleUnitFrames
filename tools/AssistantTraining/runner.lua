...
local seedCases = {
    ...
    {
        id = "party-targeted-spell-enabled",
        prompt = "turn on party targeted spell",
        expect = { kind = "changes", key = "gf_party.targetedSpellsEnabled", value = true },
        category = "party-targeted-spells",
    },
    {
        id = "party-targeted-spell-mode",
        prompt = "set party targeted spell mode to whenHealing",
        expect = { kind = "changes", key = "gf_party.targetedSpellsMode", value = "whenHealing" },
        category = "party-targeted-spells",
    },
    {
        id = "party-targeted-spell-layer",
        prompt = "set party targeted spell layer to 15",
        expect = { kind = "changes", key = "gf_party.targetedSpellsLayer", value = 15 },
        category = "party-targeted-spells",
    },
    {
        id = "party-targeted-spell-growth",
        prompt = "set party targeted spell growth to CENTER",
        expect = { kind = "changes", key = "gf_party.targetedSpellsGrow", value = "CENTER" },
        category = "party-targeted-spells",
    },
    {
        id = "party-targeted-spell-cooldown-text",
        prompt = "turn on party targeted spell cooldown text",
        expect = { kind = "unsupported", status = "info", textContains = { "do not expose", "icon size", "did not change" } },
        category = "party-targeted-spells",
    },
    {
        id = "party-targeted-spell-color-by-time",
        prompt = "turn on party targeted spell color by time",
        expect = { kind = "unsupported", status = "info", textContains = { "do not expose", "timer-color", "did not change" } },
        category = "party-targeted-spells",
    },
    {
        id = "party-targeted-spell-safe-color",
        prompt = "set party targeted spell safe color to yellow",
        expect = { kind = "unsupported", status = "info", textContains = { "do not expose", "timer-color", "did not change" } },
        category = "party-targeted-spells",
    },
    {
        id = "party-targeted-spell-warning-color",
        prompt = "set party targeted spell warning color to yellow",
        expect = { kind = "unsupported", status = "info", textContains = { "do not expose", "timer-color", "did not change" } },
        category = "party-targeted-spells",
    },
    {
        id = "party-targeted-spell-urgent-color",
        prompt = "set party targeted spell urgent color to yellow",
        expect = { kind = "unsupported", status = "info", textContains = { "do not expose", "timer-color", "did not change" } },
        category = "party-targeted-spells",
    },
    {
