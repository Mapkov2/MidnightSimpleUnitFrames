...
local expectedContains = {
    ...
    ["group text help"] = "Group Health & Text help",
    ["group health and text help"] = "Group Health & Text help",
    ["what can i change in group health and text"] = "Group Health & Text help",
    ...
    ["where can i change group health and text"] = "Group Health & Text help",
    ...
    ["is this safe"] = "Boss Bar Outline Strata decision help",
