...
chunk, err = loadfile(ResolvePath("Runtime/MSUF_ChatAndTooltips.lua"))
assert(chunk, err)
...
print(string.format(
    "PASS addon interop guards: boss container settled in %d SetParent calls, /rl yielded to rival",
    setParentCalls))
