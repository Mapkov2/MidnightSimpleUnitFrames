...
Check(Data.collectionUnionControls == 2396 and #Data.records == Data.collectionUnionControls,
...
Check(before.records == 2396, "public control inventory must equal the reviewed exhaustive finite-state union")
