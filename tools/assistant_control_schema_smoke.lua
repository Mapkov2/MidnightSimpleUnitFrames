...
Check(Data.collectionUnionControls == 2400 and #Data.records == Data.collectionUnionControls,
...
Check(before.records == 2400, "public control inventory must equal the reviewed exhaustive finite-state union")
