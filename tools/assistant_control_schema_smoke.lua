...
Check(collectionStates.base == 1595, "reviewed complete-catalog baseline")
Check(Data.collectionUnionControls == 2397 and #Data.records == Data.collectionUnionControls,
...
Check(before.records == 2397, "public control inventory must equal the reviewed exhaustive finite-state union")
...
local launchResult = Schema.TryConversation("start test heal prediction bars")
...
openedSemanticId, executedControlId, executedValue = nil, nil, nil
local modeNavigation = Schema.TryConversation("take me to test heal prediction bars")
...
openedSemanticId, executedControlId, executedValue = nil, nil, nil
local stopResult = Schema.TryConversation("stop test heal prediction bars")
...
openedSemanticId, executedControlId, executedValue = nil, nil, nil
local toggleResult = Schema.TryConversation("toggle test heal prediction bars")
