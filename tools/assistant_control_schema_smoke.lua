...
Check(Data.collectionUnionControls == 2725 and #Data.records == Data.collectionUnionControls,
...
Check(before.records == 2725, "public control inventory must equal the reviewed exhaustive finite-state union")
