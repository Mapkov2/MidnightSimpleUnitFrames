...
Check(collectionStates.base == 2076, "reviewed complete-catalog baseline")
Check(Data.collectionUnionControls == 2728 and #Data.records == Data.collectionUnionControls,
...
Check(before.records == 2728, "public control inventory must equal the reviewed exhaustive finite-state union")
