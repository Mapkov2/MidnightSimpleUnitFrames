...
Check(Data.collectionUnionControls == 2756 and #Data.records == Data.collectionUnionControls,
...
Check(before.records == 2756, "public control inventory must equal the reviewed exhaustive finite-state union")
