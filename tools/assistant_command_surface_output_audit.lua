...
local cases = {
    ...
    { input = "group text help", status = "info", contains = "Group Health & Text help" },
    ...
    { input = "where can i change group health and text", status = "info", contains = "Group Health & Text help" },
    ...
    { input = "combo points wrong color", status = "info", contains = "Class Resources color help" },
