...
$tests = @(
    ...
    ".github/scripts/tests/client_version_warning_smoke.lua",
    ...
    "tools/group_border_number_smoke.lua",
    ...
    "tools/group_preview_name_bar_anchor_smoke.lua",
    ...
    ".github/scripts/tests/group_power_parity_smoke.lua",
    ...
    ".github/scripts/tests/options_keybind_cold_open_smoke.lua",
    ...
    ".github/scripts/tests/group_portrait_parity_smoke.lua",
    ".github/scripts/tests/group_portrait_interaction_runtime_smoke.lua",
