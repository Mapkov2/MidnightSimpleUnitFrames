...
local unitFilterKeys = {
    ...
    "auras3.target.buff.filter.onlyImportant",
    "auras3.target.buff.filter.includeDispellable",
    "auras3.target.buff.filter.dispellableAny",
    ...
    "auras3.target.debuff.filter.dispellableAny",
    "auras3.target.debuff.filter.onlyImportant",
...
local unitDirectCases = {
    ...
    { "include debuffs I can dispel on target", "auras3.target.debuff.filter.raid", true },
    { "include target debuffs dispellable by group", "auras3.target.debuff.filter.includeDispellable", true },
    { "turn off dispellable by group for target debuffs", "auras3.target.debuff.filter.includeDispellable", false },
    { "include target debuffs with any dispel type", "auras3.target.debuff.filter.dispellableAny", true },
    { "show important target buffs", "auras3.target.buff.filter.onlyImportant", true },
    { "show target buffs dispellable by group", "auras3.target.buff.filter.includeDispellable", true },
    { "show target buffs with any dispel type", "auras3.target.buff.filter.dispellableAny", true },
    { "show important target debuffs", "auras3.target.debuff.filter.onlyImportant", true },
...
local unsupportedCategoryInversePrompts = {
    ...
    "exclude target debuffs dispellable by group",
    "exclude target debuffs with any dispel type",
...
local groupCases = {
    ...
    { "set raid debuff filter to dispellable by group", "gf_raid.auras.debuff.filterToken", "RAID_PLAYER_DISPELLABLE" },
    { "set raid debuff filter to any dispel type", "gf_raid.auras.debuff.filterToken", "DISPELLABLE" },
    { "set raid buff filter to important", "gf_raid.auras.buff.filterToken", "IMPORTANT" },
    { "set raid debuff filter to important", "gf_raid.auras.debuff.filterToken", "IMPORTANT" },
