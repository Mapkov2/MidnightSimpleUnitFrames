...
<!-- msuf-menu-link: {"pageKey":"uf_player","sectionId":"status_icons","controlId":"menu2.uf_player.unit.status.level.difficulty_color","settingKey":"player.levelIndicatorDifficultyColor","prepareKind":"","prepareValue":"","query":"color by level difficulty","label":"Color by level difficulty"} -->
